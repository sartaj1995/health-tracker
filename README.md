...
283 tests over the pure logic, run with `npm test` and on every pull request.
...
|:--|:--|
| [`lib/metrics.ts`](lib/metrics.ts) | All 28 metrics and their reference bands — the heart of the app |
